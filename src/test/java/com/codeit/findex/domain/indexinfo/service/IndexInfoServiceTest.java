...
class IndexInfoServiceTest {
    ...
    void saveAndFind() {
        ...
        IndexInfoCreateRequest request = new IndexInfoCreateRequest(
                "KOSPI시리즈", "IT 서비스", 200,
                LocalDate.of(2023, 1, 1), new BigDecimal("1000.00"), false
        );
    ...
    void existsByIndexClassificationAndIndexName() {
        // given
        IndexInfoCreateRequest request1 = new IndexInfoCreateRequest(
                "KOSPI시리즈", "IT 서비스", 200,
                LocalDate.of(2023, 1, 1), new BigDecimal("1000.00"), false
        );
        ...
        // when
        IndexInfoCreateRequest request2 = new IndexInfoCreateRequest(
                "KOSPI시리즈", "IT 서비스", 200,
                LocalDate.of(2023, 1, 1), new BigDecimal("1000.00"), false
        );
